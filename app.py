...
st.markdown("<center><p style='color:#444; font-size:11px; margin-top:120px;'>Simon AI v1.2.0 • Created by Sean L. Matondo<br>Powered by Lite Wrld Gen | Groq + HF 🌍</p></center>", unsafe_allow_html=True)