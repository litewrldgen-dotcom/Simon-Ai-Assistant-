...
def chat(message, history):
    ...
    if message == "/help":
        bot_message = "Got you. I can chat, code, teach, remember you, and speak. Say 'speak' to hear me. Try 'my name is Alex'"
        history.append((message, bot_message))
        return history, history, None
    ...
    try:
        ...
        response = "Sorry I had an error there. Let's try again."
